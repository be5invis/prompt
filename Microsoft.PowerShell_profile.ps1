...
function rightPromptGutterWidtth {
    param ([bool] $show);
    if ($show) {
...
function gitChangeWidth([int] $working, [int] $index) {
...
function writeGitChangeSymbol([int] $working, [int] $index, [string] $color) {
...
function rightPromptLastCommandTime {
    param ([int] $startColumn, [bool] $cont);
